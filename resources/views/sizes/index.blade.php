                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" id="menu">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/sizes/excel') }}" target="_blank" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/sizes/csv') }}" class="navi-link">
                                            <span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/sizes/pdf') }}" target="_blank" class="navi-link">
                                            <span class="navi-icon">
