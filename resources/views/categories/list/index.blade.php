                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" id="menu">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/categories/excel') }}" target="_blank" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/categories/csv') }}" class="navi-link">
                                            <span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/categories/pdf') }}" target="_blank" class="navi-link">
                                            <span class="navi-icon">
                            ...
                            <tbody>
                                <tr v-for="category in categories">
                                    ...
                                    <td class="datatable-cell">
                                        ...
                                        <span v-if="category.dog_category == true">
                                            Caninos
                                        </span>
                                    </td>
                                    
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/categories/edit') }}'+'/'+category.id"><i class="far fa-edit"></i></a>
