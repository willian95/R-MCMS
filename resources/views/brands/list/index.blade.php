                    ...
                    <div class="dropdown dropdown-inline mr-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" id="menu">
                            ...
                            <ul class="navi flex-column navi-hover py-2">
                                ...
                                <li class="navi-item">
                                    <a href="{{ url('/brands/excel') }}" target="_blank" class="navi-link">
                                ...
                                <li class="navi-item">
                                    <a href="{{ url('/brands/csv') }}" class="navi-link">
                                        <span class="navi-icon">
                                ...
                                <li class="navi-item">
                                    <a href="{{ url('/brands/pdf') }}" target="_blank" class="navi-link">
                                        <span class="navi-icon">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="brand in brands">
                                    ...
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/brands/edit') }}'+'/'+brand.id"><i class="far fa-edit"></i></a>
                                        <button class="btn btn-secondary" @click="erase(brand.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
