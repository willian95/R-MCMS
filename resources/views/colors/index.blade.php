                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" id="menu">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('colors/excel') }}" target="_blank" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/colors/csv') }}" class="navi-link">
                                            <span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/colors/pdf') }}" target="_blank" class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="color in colors">
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#categoryModal" @click="edit(color)"><i class="far fa-edit"></i></button>
