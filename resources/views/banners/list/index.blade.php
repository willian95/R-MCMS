                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="banner in banners">
                                    ...
                                    <td class="datatable-cell">
                                        <img :src="banner.image" alt="" style="width: 250px;" v-if="banner.type == 'image'">

                                        <video class="w-100" controls v-if="banner.type == 'video'">
                                    ...
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/banners/edit') }}'+'/'+banner.id"><i class="far fa-edit"></i></a>
                                        <button class="btn btn-secondary" @click="erase(banner.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
