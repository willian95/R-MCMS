            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Crear banner
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small v-if="errors.hasOwnProperty('url')">@{{ errors['url'][0] }}</small>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Imagen principal o video (jpg, png, mp4 | Dimensiones recomendadas: 1110x500px )</label>
...
@push("scripts")
    ...
    @include("banners.create.scripts")
