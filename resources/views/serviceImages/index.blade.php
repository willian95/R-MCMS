                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Imágen o video clínica (jpg,png, mp4 | Dimensiones recomendadas: 1110x500px | max: 4mb )</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Imágen o video peluquería (jpg,png, mp4 | Dimensiones recomendadas: 1110x500px | max: 4mb )</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Imágen o video hotel (jpg,png, mp4 | Dimensiones recomendadas: 1110x500px | max: 4mb )</label>
