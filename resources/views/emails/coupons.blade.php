                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="540" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#010101;"> Tu código de descuento es: <strong>{{ $data['coupon_code'] }}</strong>  </span><br></p></td> 
                     </tr> 

                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#010101; text-align: justify;">Hola <strong>{{ $data["user_name"] }}</strong>, has recibido un cupón de descuento por <strong>{{ number_format($data['discount_amount'], 0, ",", ".") }} @if($data['discount_type'] == 'neto') $ @else % @endif</strong> disponible hasta la fecha <strong> {{ Carbon\Carbon::createFromFormat('Y-m-d', $data['end_date'])->format('d-m-Y') }} </strong> y que puede ser aplicado @if($data["total_discount"] == 'carrito')<strong>a todo el carrito.</strong> @else <strong>solo a los productos seleccionados debajo<strong>. @endif</span><br></p></td> 
                     </tr> 

                     

                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#010101;"> Disponible para:  </span><br></p></td> 
                     </tr> 


                     <tr style="border-collapse:collapse;"> 
                        @if($data['all_products'] == 0)
                            <table style="width: 100%; border: 1px solid grey; border-collapse: collapse;">
                                <thead>
                                    <tr>
                                        <th style="border: 1px solid grey;">Producto</th>
                                        <th style="border: 1px solid grey;">Marca</th>
                                        <th style="border: 1px solid grey;">Presentación</th>
                                        <th style="border: 1px solid grey;">Tamaño</th>
                                        <th style="border: 1px solid grey;">Precio</th>
                                        <th style="border: 1px solid grey;">Link</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($data['products'] as $product)
                                        ...
                                        @php
                                            $productInfo =  App\Models\ProductFormat::with(["product", "size", "color", "product.brand"])->where("id", $product['id'])->first();
                                            
                                        @endphp

                                        <tr>
                                            <td style="border: 1px solid grey; font-size: 10px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;">{{ $productInfo->product->name }}</td>
                                            <td style="border: 1px solid grey; font-size: 10px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;">{{ $productInfo->product->brand->name }}</td>
                                            <td style="border: 1px solid grey; font-size: 10px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;">{{ $productInfo->color->color }}</td>
                                            <td style="border: 1px solid grey; font-size: 10px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;">{{ $productInfo->size->size }}</td>
                                            <td style="border: 1px solid grey; font-size: 10px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;">$ 
                                            
                                            
                                            {{ number_format($productInfo->price, 0, ",", ".") }}</td>
                                            <td style="border: 1px solid grey; font-size: 10px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;"><a href="{{ $data['APP_URL'].'producto/'.$productInfo->product->slug }}">Link</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        @else
                            ...
                            <tr style="border-collapse:collapse;"> 
                                <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#010101;"> Todos los productos</strong>  </span><br></p></td> 
                            </tr> 
