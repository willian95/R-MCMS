                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" id="menu">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('staffs/excel') }}" target="_blank" class="navi-link">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/staffs/csv') }}" class="navi-link">
                                            <span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="{{ url('/staffs/pdf') }}" target="_blank" class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="staff in staffs">
                                    ...
                                    <td class="datatable-cell">
                                        <img :src="staff.image" alt="" style="width: 250px;">
                                    </td>
                                    <td class="datatable-cell">
                                        @{{ staff.job }}
                                    </td>
